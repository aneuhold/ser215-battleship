    ...
    public void updateGameStatus(GamePlay turnOrder) {
        ...
        if (turnOrder.gameStatus.equals("players turn")) {
            ...
            ConsoleOutput.display("It's your turn,\n" +
                    "Choose your attack on the Opponent Grid to the right!\n");
        }
            ...
            for (row = 0; row < 10; row++) {
                ...
                square.addActionListener(e -> {
                    ...
                    if (turnOrder.gameStatus.equals("players turn") && (gameHasStarted == true)) {
                        ...
                        if (userHits[0] >= 17) {
                            ConsoleOutput.display("You've Won!\n"+
                            "with an accuracy of "+ (userHits[0] / GamePlay.turnsTaken));
                            BattleShipMain.gameOver = true;
                        } else { turnOrder.switchTurns(); }
                    }
                    //printTo(console, msg);
                });
