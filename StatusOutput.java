...
/** StatusOutput.java    [ ser215-group-project-jfijewsk-patch-2 ]
 * by Ryan Migaud   < Rmigaud@asu.edu >  on: 9/30/2017   at: 1:18 PM
...
public class StatusOutput extends JTextArea {
    ...
    /** update(msg)     appends a message and forces the focus to the
     * bottom of the JTextArea*/
